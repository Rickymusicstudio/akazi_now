...
const BUCKET = "market-images"; // create this bucket in Supabase Storage
const CATEGORIES = [
  "electronics",
  "houses",
  "plots",
...
function PostIsoko() {
  ...
  async function uploadImageIfAny() {
    ...
    if (file.type === "image/heic" || /\.heic$/i.test(file.name)) {
      throw new Error("Please upload JPG/PNG (HEIC is not supported by browsers).");
    }
    ...
    // if private bucket, use signed URL:
  ...
  return (
    <div className="gigs-container">
      ...
      {mobileNavVisible && (
        <div ref={mobileNavRef} className={`gigs-mobile-nav-overlay ${slideDirection}`}>
          <ul>
            ...
            <li onClick={() => { setMobileNavVisible(false); navigate("/isoko/categories/electronics"); }}>Electronics</li>
            <li onClick={() => { setMobileNavVisible(false); navigate("/isoko/categories/houses"); }}>Houses</li>
            <li onClick={() => { setMobileNavVisible(false); navigate("/isoko/categories/plots"); }}>Plots</li>
            <li onClick={() => { setMobileNavVisible(false); navigate("/isoko/categories/cars"); }}>Cars</li>
            <li onClick={() => { setMobileNavVisible(false); navigate("/isoko/categories/kitchen"); }}>Kitchen</li>
            <li onClick={() => { setMobileNavVisible(false); navigate("/isoko/categories/clothes"); }}>Clothes</li>
            {authUser ? (
      ...
      <section className="gigs-cards-section" style={{ paddingTop: "2rem" }}>
        <div className="gigs-card" style={{ maxWidth: 800, width: "100%", margin: "0 auto" }}>
          <form onSubmit={handleSubmit} className="isoko-form">
            <div className="gigs-card-text">
              ...
              <div style={{ display: "flex", justifyContent: "flex-end", gap: "10px", marginTop: "10px" }}>
                <button type="button" onClick={() => navigate("/isoko")}>Cancel</button>
